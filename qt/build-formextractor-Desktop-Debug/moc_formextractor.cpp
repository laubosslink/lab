...
#include "../qt-webkit/formextractor.h"
...
struct qt_meta_stringdata_FormExtractor_t {
    QByteArrayData data[4];
    char stringdata[54];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    offsetof(qt_meta_stringdata_FormExtractor_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData) \
    )
static const qt_meta_stringdata_FormExtractor_t qt_meta_stringdata_FormExtractor = {
    {
QT_MOC_LITERAL(0, 0, 13),
QT_MOC_LITERAL(1, 14, 6),
QT_MOC_LITERAL(2, 21, 0),
QT_MOC_LITERAL(3, 22, 30)
    },
    "FormExtractor\0submit\0\0"
...
const QMetaObject FormExtractor::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_FormExtractor.data,
      qt_meta_data_FormExtractor,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_FormExtractor.stringdata))
