# -*- coding: utf-8 -*-
"""
Created on Thu Jul 26 23:24:11 2012

@author: laubosslink
"""
#laubosslink@PC-LBL:/media/files/S-lbl/Lab/python-speechtotext$ sudo aptitude search gstreamer | grep sphinx
...
class DemoApp(object):
    ...
    def init_gst(self):
        ...
        asr.set_property('lm', '/usr/share/libexttextcat/fr.lm')
        asr.set_property('dict', '')
