...
<html>
	...
	<body>
		...
		<form method="post" id="the_form_form" data-call-ajax="<?php call_ajax_method("radio_form"); ?>">
		<br />
		You need ? 
		...
		<form method="post" id="the_form" data-call-ajax="<?php call_ajax_method("radio_a"); ?>">
		<br />
		<label for="need_a[arr]">You need ?</label> 
		Yes <input type="radio" name="need_a[arr]" value="yes" />
		/ No <input type="radio" name="need_a[arr]" value="no" />
		<br /> Value : <span id="radio-form_response_a"></span>
		<br /><input type="submit" />
		</form>
		<br />
		<br />
		...
		<form method="post" action="hello" data-call-ajax="<?php call_ajax_method("ip_form"); ?>">
